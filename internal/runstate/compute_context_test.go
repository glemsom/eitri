...
func TestComputeContext_EmptyInput(t *testing.T) {
	...
	result := ComputeContext([]message.Message{}, 128000, nil, "")
...
func TestComputeContext_ToolRoleIsHistory(t *testing.T) {
	...
	msgs := []message.Message{
		...
		{Role: "assistant", Content: "", ToolCalls: []message.ToolCall{{ID: "call_1", Function: message.FunctionCall{Name: "bash", Arguments: "{}"}}}},
