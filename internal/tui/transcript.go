...
// apply folds one tool-call observation into the transcript's log ( AC1/AC2): tool updates now route through the Transcript so they land in the same log renderPane reads.
