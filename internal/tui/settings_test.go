...
// TestSettingsForm_ThinkingToggleFliplips validates the reasoning mode (on/off)
// toggles ThinkingEnabled while retaining the effort selection, so toggling
// back on restores the original effortTier (issue #56).
