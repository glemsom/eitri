...
func SessionsCleanup(diskUsageBytes int64) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "</span></div><div class=\"cleanup-actions\"><button class=\"btn btn-danger\" hx-post=\"/api/sessions/cleanup/delete-closed\" hx-confirm=\"Delete ALL closed sessions permanently? This cannot be undone.\" hx-target=\"#sessions-list\" hx-swap=\"outerHTML\">Delete All Closed Sessions</button> <button class=\"btn btn-danger\" hx-post=\"/api/sessions/cleanup/clear-all-traces\" hx-confirm=\"Clear all trace files from all sessions? Session data will be preserved.\" hx-target=\"#sessions-cleanup\" hx-swap=\"outerHTML\">Clear All Traces</button></div><div class=\"cleanup-prune\"><label for=\"prune-age-days\">Prune sessions older than</label> <input type=\"number\" id=\"prune-age-days\" name=\"age_days\" class=\"input\" value=\"7\" min=\"1\" style=\"width:5em;text-align:center;\"> <span class=\"cleanup-label\">days</span> <button class=\"btn btn-danger\" hx-post=\"/api/sessions/cleanup/prune-by-age\" hx-include=\"#prune-age-days\" hx-confirm=\"Permanently delete closed sessions older than the specified days?\" hx-target=\"#sessions-list\" hx-swap=\"outerHTML\">Prune</button></div></div></details>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
