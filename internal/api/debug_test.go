...
func TestDebugSessionByID_WithMessages(t *testing.T) {
	...
	sessionMgr.AppendMessage(sess.ID, message.Message{Role: "user", Content: "Hello", CreatedAt: time.Now()})
	sessionMgr.AppendMessage(sess.ID, message.Message{Role: "assistant", Content: "Hi!", CreatedAt: time.Now()})
