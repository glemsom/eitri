  ...
  event.waitUntil(
    caches.open(CACHE).then((cache) => {
      ...
      return cache.addAll([
        ...
        "/static/eitri-stream-common.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-toolcards.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-announcer.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-tokens.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-confirmation.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-scroll.js?v=__EITRI_VERSION__",
        "/static/eitri-stream-render.js?v=__EITRI_VERSION__",
