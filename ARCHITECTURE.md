...
- `skills.go` — skill discovery and validation under user/project scopes (project shadows user), the trust-gated catalog backing both the human slash surface and the model-facing skill index (`ModelInvocable` flag), and the rendered index.
