...
- The TUI surfaces detected skills through that slash-command completion list; the right context rail is STATS / CONTEXT / MODEL only and never lists skills (issue #188)
