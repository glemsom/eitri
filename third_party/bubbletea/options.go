...
// WithoutScrollOptim disables fullscreen terminal hard-scroll operations.
// Use this when the view contains terminal-managed graphics that must remain
// fixed while text rows change.
func WithoutScrollOptim() ProgramOption {
	return func(p *Program) {
